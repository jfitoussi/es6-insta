...
// import assert as myAssert from 'assert'; // Ne fonctionne pas
// import {assert as myAssert} from 'assert'; // Non plus
// import * as myAssert from 'assert'; // Non plus
import myAssert from 'assert' //fonctionne
